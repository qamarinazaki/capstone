        ...
        <div class="col-md-6">
            <div class="card shadow-lg border-0 rounded-4" style="border-top: 5px solid #dc3545;">
                <div class="card-header bg-white text-center py-3">
                    <h3 class="mb-0 fw-bold" style="color: #dc3545;"><i class="bi bi-pencil-square me-2"></i>Edit Locker: {{ $locker->locker_number }}</h3>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.lockers.update', $locker) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('locker_number') is-invalid @enderror" 
                                   ...
                                   value="{{ old('locker_number', $locker->locker_number) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('esp_ip') is-invalid @enderror" 
                                   id="esp_ip" name="esp_ip" 
                                   value="{{ old('esp_ip', $locker->esp_ip) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                ...
                                <option value="occupied" {{ $locker->status == 'occupied' ? 'selected' : '' }}>Occupied</option>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-outline-red px-4">
                                <i class="bi bi-save me-1"></i> Update Locker
                            </button>
                        </div>
                    </form>
                </div>
